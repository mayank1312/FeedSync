...
export const FeedbackForm = ({ onSubmit }: FeedbackFormProps) => {
  ...
  return (
   <Card className="max-w-2xl mx-auto shadow-lg border dark:border-slate-700 bg-white/70 dark:bg-slate-800/90 backdrop-blur-sm transition-colors">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="feedback" className="text-slate-700 dark:text-slate-300 font-medium">
              Your Feedback *
            </Label>
            <Textarea
              id="feedback"
